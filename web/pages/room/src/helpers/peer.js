class PeerBuilder {
  ...
  // add behavior of the call events also to whom called you
  _preparePeerInstanceFunction(PeerModule) {
    ...
    PeerCustomModule.prototype.call = function (id, stream) {
      ...
      // here happens the magic, we will intercept the "call" 
      // and we will add all the events of the call also to
      // who called you
